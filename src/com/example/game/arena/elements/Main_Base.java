...
private String source_path=null;
	public Main_Base(ccColor4B color, String campaign_path, float scale_factor, String is_who ) 
	{
		...
		bar_life.setBarPosition(CGPoint.make(0, 0));
	...
	public void setSize(CGSize main_size)
	{
		this.setContentSize(main_size.width*scale_factor, main_size.height*scale_factor);
		 base_element.setSize(this.getContentSize());
		 bar_life.setSize(CGSize.make(base_element.getContentSize().width*0.63f, base_element.getContentSize().height*0.63f));
	}
