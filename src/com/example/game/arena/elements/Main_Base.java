...
private static  String source_path=null;
	public Main_Base(ccColor4B color, final String campaign_path, float scale_factor, String is_who ) 
	{
		super(color);
	...
	public void setSize(CGSize main_size)
	{
		//this.setContentSize(main_size.width*scale_factor, main_size.height*scale_factor);
		 float scalex = main_size.width*scale_factor/this.getContentSize().width;
		 float scaley =  main_size.height*scale_factor/this.getContentSize().height;
		 this.setContentSize(main_size.width*scale_factor, main_size.height*scale_factor);
		...
		// base_element.setScaleY(scaley);
		 ...
		 System.out.println("kap"+this.getContentSize());
