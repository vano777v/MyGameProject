...
public class Bear_Box extends Main_Personage {

	public Bear_Box(ccColor4B color, String campaign_path, String default_path,Game_Arena _arena, String is_who) 
	{
		super(color, campaign_path, default_path, _arena, is_who);
		this.attack_particle = new ArrayList<Particle_Element>();
		// TODO Auto-generated constructor stub
	}
	public Bear_Box(Main_Personage personage)
	{
		super(personage);
	}
	@Override
