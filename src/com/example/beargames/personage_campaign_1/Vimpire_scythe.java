...
public class Vimpire_scythe extends Main_Personage
{

	public Vimpire_scythe(ccColor4B color, String campaign_path,String default_path, Game_Arena _arena, String is_who) {
		super(color, campaign_path, default_path, _arena, is_who);
		attack_particle= new ArrayList<Particle_Element>();
		// TODO Auto-generated constructor stub
	}
	public Vimpire_scythe(Main_Personage personage)
	{
		super(personage);
	}
	@Override
